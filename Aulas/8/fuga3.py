...
def max_path(grid, row, col, rowf, colf):
    ...
    for drow, dcol in ((-2, 0), (0, -2), (0, 2), (2, 0)):
...
# max_path returns `maximum path` taking two cells at a time. So, total number of cells is `2*maximum path + 1`.
print(2 * max_path(grid, rowi, coli, rowf, colf) + 1) 
